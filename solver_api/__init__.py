...
All the APIs work simiarly, they take the matrix A, the vector b and vector c as input of the problem
    min : c^T * X s.t. A * X <= b
and passes it to the corresponding solver.
  ...
  Typical usage example:
   ...
   solution, objective, status, solver_info = api_solver(matrix_a, vector_b, vector_c,
