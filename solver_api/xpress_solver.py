...
and passes it to the xpress solver.
  ...
  Typical usage example:
   ...
   solution, objective, status, solver_info = xpress_solver(matrix_a, vector_b, vector_c,
...
def xpress_solver(matrix_a: coo_matrix, vector_b: np.ndarray, vector_c: np.ndarray, objective_offset: float,
    ...
    """xpress_solver
        ...
        of the problem : min c^T * x s.t. A * x <= b found by the xpress solver
    ...
    try:
        ...
        with open('solver_api/xpress.opt', 'r') as optfile:
